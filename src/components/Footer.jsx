        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="mb-4 md:mb-0">
              <a href="#heroSection" className="flex items-center group">
            ...
            <div className="flex gap-4">
              <a href="https://github.com/ahsakib" target="_blank" className="text-gray-400 hover:text-green-500 transition-colors">
                <svg
              ...
              <a href="https://www.linkedin.com/in/anowar-shakib/" target="_blank" className="text-gray-400 hover:text-green-500 transition-colors">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="18"
                  height="18"
