      ...
      >
        <div className="flex flex-col justify-center items-center h-full space-y-8 p-4">
          ...
          <div className="flex space-x-6 mt-8">
            <a href="https://github.com/ahsakib" target="_blank" className="text-gray-400 hover:text-green-500 transition-colors transform hover:scale-125">
              <svg
            ...
            <a href="https://www.linkedin.com/in/anowar-shakib" target="_blank" className="text-gray-400 hover:text-green-500 transition-colors transform hover:scale-125">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
