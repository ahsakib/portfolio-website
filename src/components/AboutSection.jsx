    ...
    >
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="flex flex-col md:flex-row gap-12 items-center">
          {/* Image with enhanced animated border */}
          <div className="w-full md:w-5/12 relative group">
            <div className="relative w-full max-w-md mx-auto aspect-square overflow-hidden rounded-2xl border-2 border-green-500/20 p-2 hover:border-green-500/50 transition-all duration-700">
          ...
          <div className="w-full md:w-7/12">
            ...
            <div className="flex mb-6 border-b border-green-500/20">
              <button
                className={`px-4 py-2 relative ${activeTab === "about" ? "text-green-500" : "text-gray-400"} transition-colors duration-300`}
              ...
              <button
                className={`px-4 py-2 relative ${activeTab === "education" ? "text-green-500" : "text-gray-400"} transition-colors duration-300`}
              ...
              <button
                className={`px-4 py-2 relative ${activeTab === "experience" ? "text-green-500" : "text-gray-400"} transition-colors duration-300`}
            ...
            <div className="min-h-[200px] relative">
              ...
              >
                ...
                {/* Enhanced personal info grid with hover effects */}
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
                  <div className="flex items-center group">
                    ...
                    <span className="text-white ml-2 group-hover:text-green-500 transition-colors">Anowar Shakib</span>
                  </div>
                  <div className="flex items-center group">
                    <span className="w-2 h-2 bg-green-500 rounded-full mr-2 group-hover:scale-150 transition-transform"></span>
                    <span className="text-gray-400">Phone:</span>
                    <span className="text-white ml-2 group-hover:text-green-500 transition-colors">+8801824630876</span>
                  </div>
                  <div className="flex items-center group">
                    <span className="w-2 h-2 bg-green-500 rounded-full mr-2 group-hover:scale-150 transition-transform"></span>
                    <span className="text-gray-400">Email:</span>
                    <span className="text-white ml-2 group-hover:text-green-500 transition-colors">
              ...
              >
                <div className="relative pl-8 pb-6 border-l border-green-500/30 group">
                  ...
                  <h4 className="text-xl font-semibold text-white mb-1 group-hover:text-green-500 transition-colors">
