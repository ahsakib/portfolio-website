      ...
      <div className="container mx-auto px-4 z-10">
        <div className="max-w-2xl mx-auto md:mx-0">
          ...
          <div className="flex mt-8 space-x-5 md:hidden">
            <a href="https://github.com/ahsakib" target="_blank" className="text-gray-400 hover:text-green-500 transition-colors transform hover:scale-110">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="20"
                height="20"
            ...
            <a href="https://www.linkedin.com/in/anowar-shakib" target="_blank" className="text-gray-400 hover:text-green-500 transition-colors transform hover:scale-110">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="20"
                height="20"
            ...
            <a href="mailto:ahshakib572@gmail.com" className="text-gray-400 hover:text-green-500 transition-colors transform hover:scale-110">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="20"
                height="20"
